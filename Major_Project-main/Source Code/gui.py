...
def start():
    ...
    if running is not None:
        ...
        running = rec.open(audio_path, 'wb')
...
def run():
    summary_path = os.path.join(BASE_DIR, "summarization.py")
    os.system(f'python "{summary_path}"')
...
image_path = os.path.join(BASE_DIR, "..", "Images", "background.jpeg")
audio_path = os.path.join(BASE_DIR, "..", "AudioFile", "audio.wav")
